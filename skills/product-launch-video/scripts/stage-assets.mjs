...
// public/ so Step 5 frame workers reference real files and the live preview
...
// Writes: public/<basename> for each named, found asset.
...
console.log(`✓ staged ${staged}/${wanted.size} asset(s) into public/`);
if (anomalies.length) {
  console.log(`\nanomalies (non-fatal):`);
