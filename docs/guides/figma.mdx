...
<img src=".media/images/image_007.svg" alt="Hero illustration" />
```
...
- Accepted refs: full Figma URL, `fileKey:nodeId` shorthand, or bare `fileKey`.
...
| `BAD_TOKEN` (401) | Token expired, revoked, or under-scoped | Re-mint with the read-only scopes above |
